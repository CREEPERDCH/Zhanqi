...
/**
 * Created by CREEPERDCH on 2017/9/25.
 * HINT:
 */
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(view -> Snackbar.make(view, "您还未申请成为战旗主播", Snackbar.LENGTH_LONG)
                .setAction("申请主播", view1 -> new AlertDialog
                        .Builder(MainActivity.this)
                        .setTitle("申请主播")
                        .setMessage("确认申请成为战旗直播平台的主播吗?")
